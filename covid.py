...
task_mkdir = BashOperator(
    task_id='mkdir',
    bash_command='mkdir -p /opt/airflow/dados/raw/danilo_1111/covid19 /opt/airflow/dados/trusted/danilo_1111/covid19 /opt/airflow/dados/refined/danilo_1111/covid19'
)
task_csvtoraw = PythonOperator(
    task_id='csvtoraw',
    python_callable=csvtoraw,
    op_args=['/opt/airflow/dados/INFLUD21-11-01-2021.csv',';','/opt/airflow/dados/raw/danilo_1111/covid19/covid_raw.parquet','snappy'],
    dag=dag,
)
...
task_rawtotrusted = PythonOperator(
    ...
    op_args=['/opt/airflow/dados/trusted/danilo_1111/covid19/covid_trusted.parquet','snappy'],
    dag=dag,
)
...
task_trustedtorefined = PythonOperator(
    ...
    op_args=['/opt/airflow/dados/refined/danilo_1111/covid19/covid_refined.parquet','snappy'],
    dag=dag,
)
